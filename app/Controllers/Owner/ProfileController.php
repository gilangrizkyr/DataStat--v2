 ...
 * ============================================================================
 * 
 * Path: app/Controllers/Owner/ProfileController.php
 * 
 * Deskripsi:
 * Controller untuk owner mengelola profile sendiri.
 * Update data pribadi, change password, upload avatar.
 * 
 * Fitur:
 * - View profile
...
class ProfileController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('owner/profile/index', $data);
    }
    ...
    public function update()
    {
        ...
        try {
            ...
            $this->logActivity('update', 'profile', 'Owner update profile');
    ...
    public function changePassword()
    {
        ...
        try {
            ...
            $this->logActivity('update', 'profile', 'Owner change password');
    ...
    public function uploadAvatar()
    {
        ...
        try {
            ...
            if ($avatar && $avatar->isValid() && !$avatar->hasMoved()) {
                ...
                $this->logActivity('update', 'profile', 'Owner upload avatar');
